...
SECRET_KEY = 'django-insecure-25_rj@p)k_mfu%3sf!lg-*%#9kqpeycq2ael!%)a&vyyr-t25a'
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': 'sibo1234',   # User's password
...
AUTHENTICATION_BACKENDS = [
    ...
    'users.authentication_backends.EmailBackend',  # this is the custom auth
]
